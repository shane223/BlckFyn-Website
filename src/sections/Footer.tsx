const Footer = () => {
  ...
  const footerLinks = [
    {
      title: 'Company',
      links: ['About', 'Strategy', 'Team', 'Careers'],
    },
    {
      title: 'Investments',
      links: ['Portfolio', 'Case Studies', 'Performance', 'Reports'],
    },
    {
      title: 'Resources',
      links: ['Insights', 'News', 'Events', 'Contact'],
    },
  ];

  return (
    <footer className="bg-black text-white py-16 px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              deep sector expertise with operational excellence.
            </p>
          </div>
